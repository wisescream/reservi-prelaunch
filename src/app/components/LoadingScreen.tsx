...
export function LoadingScreen() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white overflow-hidden select-none pointer-events-none">
      <motion.div
        variants={containerVariants}
        initial="hidden"
        animate="visible"
        className="relative flex items-baseline gap-1"
        style={{ fontFamily: lang === "ar" ? "sans-serif" : "'Plus Jakarta Sans', 'Inter', sans-serif", direction: lang === "ar" ? "rtl" : "ltr" }}
      >
        {lang === "ar" ? (
          <motion.span
            variants={letterVariants}
            className="text-[#E8450A] font-extrabold"
      ...
      <motion.div
        ...
        style={{ fontSize: "0.85rem", fontFamily: lang === "ar" ? "sans-serif" : "'Plus Jakarta Sans', 'Inter', sans-serif" }}
      >
        {lang === "ar" ? "احجز طاولتك" : lang === "fr" ? "RÉSERVEZ VOTRE TABLE" : "BOOK YOUR TABLE"}
      </motion.div>
    </div>
  );
}
